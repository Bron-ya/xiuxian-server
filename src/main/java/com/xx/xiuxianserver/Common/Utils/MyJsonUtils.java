...
public class MyJsonUtils {
  ...
  static {
    ...
    OBJECT_MAPPER.configure(JsonWriteFeature.WRITE_NUMBERS_AS_STRINGS.mappedFeature(), true);
  }
  ...
  public static <T> T parse(String json, Type targetType) {
    try {
      return OBJECT_MAPPER.readValue(json, TypeFactory.defaultInstance().constructType(targetType));
    } catch (IOException e) {
